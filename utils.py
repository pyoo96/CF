...
def calc_perturbed_loss(net, trainloader, testloader, radius, num_samples, criterion, detailed=False):
    """
    ...
    for _ in num_samples:
        ...
        with torch.no_grad():
            ...
            train_loss, acc = train_loss / len(trainloader), 100 * correct / (total + 1e-8)
            ...
            if (detailed):
                ...
                test_loss, acc = test_loss / len(testloader), 100 * correct / total
